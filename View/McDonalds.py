...
class Odd_Mcdonald(QWidget):
    ...
    def __init__(self):
        ...
        self.BlueButton_2.clicked.connect(self.add_to_cart)
    ...
    def clear_all(self): 
        ...
        self.string=""
        try:
            os.remove("C:/Users/RUIZHI/Desktop/mini_project/cart.txt")
        except:
            pass
...
"")
        ...
        self.items_dic={
            "item_one" : [self.item_one_num,self.item_one_price,self.item_one_text] ,
            "item_two" : [self.item_two_num,self.item_two_price,self.item_two_text] ,
            "item_three" : [self.item_three_num,self.item_three_price,self.item_three_text] ,
            "item_four" : [self.item_four_num,self.item_four_price,self.item_four_text] ,
            "item_five" : [self.item_five_num,self.item_five_price,self.item_five_text] ,
            "item_six" : [self.item_six_num,self.item_six_price,self.item_six_text] ,
            "item_seven" : [self.item_seven_num,self.item_seven_price,self.item_seven_text] ,
            "item_eight" : [self.item_eight_num,self.item_eight_price,self.item_eight_text] ,
            "item_nine" : [self.item_nine_num,self.item_nine_price,self.item_nine_text] ,
            "item_ten" : [self.item_ten_num,self.item_ten_price,self.item_ten_text] ,
        }
